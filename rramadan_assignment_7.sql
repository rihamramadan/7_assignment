...
-- You don't think you will be performing queries on a description, so create 
...
-- Use the solution from the problem above to create a view. If you haven't solved 7h, you can substitute another 
